...
recipes.addShapeless(<minecraft:stone_pickaxe>, [<ore:string>, <minecraft:flint>, <minecraft:flint>, <minecraft:stick>]);
recipes.addShapeless(<minecraft:stone_axe>, [<minecraft:flint>, <ore:string>, <minecraft:cobblestone>, <minecraft:stick>]);
recipes.addShapeless(<minecraft:stone_hoe>, [<minecraft:flint>, <minecraft:string>, <minecraft:stick>]);
...
recipes.addShaped(<minecraft:diamond_pickaxe>, [
	[<minecraft:diamond>, <ore:ingotSteel>, <minecraft:diamond>],
	[<betterwithmods:material:3>, <immersiveengineering:material>, null],
...
recipes.addShaped(<minecraft:bucket>,[
	[null, null, null],
	[<ore:ingotSteel>, <immersiveengineering:tool>.transformDamage(3), <ore:ingotSteel>],
...
recipes.addShaped(<minecraft:fishing_rod>,[
	[<minecraft:string>, <minecraft:string>, <minecraft:stick>],
	[<minecraft:string>, null, <minecraft:stick>],
	[<minecraft:iron_nugget>, null, <minecraft:stick>]
]);

recipes.remove(<minecraft:sign>);
recipes.addShapeless(<minecraft:sign>,[<minecraft:wooden_pressure_plate>, <minecraft:stick>]);
...
recipes.addShaped(<minecraft:dispenser>, [
	[<minecraft:stick>, <minecraft:bow>, <minecraft:stick>],
	[<betterwithmods:material>, <minecraft:furnace>, <betterwithmods:material>],
	[<minecraft:stone_button>, <minecraft:repeater>, <minecraft:stone_button>]
]);
